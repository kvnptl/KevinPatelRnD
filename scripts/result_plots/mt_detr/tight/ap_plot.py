...
root_path = "/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/scripts/result_plots/mt_detr/tight/"
...
plt.grid(True)
plt.title('MT-DETR Tightly-Coupled Fusion across modalities: Average Precision (AP) by weather conditions')
