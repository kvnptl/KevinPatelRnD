...
root_path = "/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/scripts/result_plots/mt_detr/middle/"
...
plt.grid(True)
plt.title('MT-DETR Middle Fusion across modalities: Average Precision (AP) by weather conditions')
