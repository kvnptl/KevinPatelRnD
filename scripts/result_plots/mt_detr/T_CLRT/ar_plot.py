...
root_path = "/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/scripts/result_plots/mt_detr/T_CLRT/"
...
colors_ar = ['red', 'green', 'orange', 'brown']
...
plt.plot(x_values_ar, p_ar(x_values_ar), "k--", linewidth=2, label="Trend (C+L+R+T)")
...
plt.grid(True)
plt.title('MT-DETR Tightly-Coupled across modalities: Average Recall (AR) by weather conditions')
