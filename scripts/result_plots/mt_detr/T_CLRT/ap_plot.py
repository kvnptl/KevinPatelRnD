...
# Plot the trendline
plt.plot(x_values, p(x_values), "k--", linewidth=2, label="Trend (C+L+R+T)")
...
plt.grid(True)
plt.title('MT-DETR Tightly-Coupled across modalities: Average Precision (AP) by weather conditions')
