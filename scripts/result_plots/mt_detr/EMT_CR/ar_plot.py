...
root_path = "/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/scripts/result_plots/mt_detr/EMT_CR/"
...
plt.plot(x_values_ar, p_ar(x_values_ar), "k--", linewidth=2, label="Trend (Tightly-coupled)")
...
plt.grid(True)
plt.title('MT-DETR C+R across fusion architectures: Average Recall (AR) by weather conditions')
