...
root_path = "/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/scripts/result_plots/hrfuser_vs_mt_detr/cr/"
...
plt.grid(True)
plt.title('MT-DETR vs. HRFuser: C+R with Tightly-Coupled Fusion: Average Recall (AR) by weather conditions')
