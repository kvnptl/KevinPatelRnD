...
file_path = root_path + 'ap_2.txt'  # Update this with the actual path
...
clr_y_values = [ap for weather in ap_values.values() for ap in weather[3]]
...
plt.grid(True)
plt.title('HRFuser across modalities: Average Precision (AP) by weather conditions')
