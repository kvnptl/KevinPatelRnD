...
# Define file paths
saf_fcos_json = "/home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/datasets/nuScenes/v1.0-trainval/gt_fcos_coco_test.json"
...
if not run_testset:
    filtered_annotations = [ann for ann in hrfuser_data["annotations"]
