"""
This script is for MT-DETR .out file data extraction
"""
...
for line in lines:
    ...
    if re.search(r"bbox_mAP_copypaste", line):
        ...
        if match:
            ...
            bbox_mAP_copypaste = [round(float(i)*100, 2) for i in bbox_mAP_copypaste]
