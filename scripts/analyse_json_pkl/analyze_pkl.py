...
with open('/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/hrfuser_cuda11p1/data/dense/dense_infos_all_modified_van_as_car.pkl', 'rb') as file:
...
# Replace 'Van' to 'Car' class
a = input("Are you sure you want to replace 'Van' to 'Car'? (sure/not): ")
...
for d in data:
    if d['image']['image_idx'] == '2018-02-07_18-39-52_00300' or d['image']['image_idx'] == '2018-12-12_15-21-22_00300' or d['image']['image_idx'] == '2018-12-12_15-21-22_02700' or d['image']['image_idx'] == '2018-12-12_15-18-40_00400' or d['image']['image_idx'] == '2018-12-14_15-27-11_04300':
        for i, class_names in enumerate(d['annos']['name']):
            if class_names == 'Van':
                d['annos']['name'][i] = 'Car'
...
# Write the modified data back to the file
with open('/home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/hrfuser_cuda11p1/data/dense/dense_infos_all_modified_van_as_car.pkl', 'wb') as file:
