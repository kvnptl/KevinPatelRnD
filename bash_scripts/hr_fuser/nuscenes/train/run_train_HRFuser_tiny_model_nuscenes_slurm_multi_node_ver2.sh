...
#SBATCH --ntasks-per-node=16    # cores
...
#SBATCH --output train_hrfuser_TINY_nuScenes_c_l_r_fusion_epoch_12_batch_16_orig_config_multi_node_slurm_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_hrfuser_TINY_nuScenes_c_l_r_fusion_epoch_12_batch_16_orig_config_multi_node_slurm_gpu_output.%j.err  # filename for STDERR
