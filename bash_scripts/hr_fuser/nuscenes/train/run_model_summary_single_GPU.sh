...
#SBATCH --output model_summary_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error model_summary_output.%j.err  # filename for STDERR
...
python tools/train.py /home/kpatel2s/kpatel2s/sensor_fusion_rnd/KevinPatelRnD/hrfuser/configs/hrfuser/cascade_rcnn_hrfuser_t_1x_nus_r640_l_r_fusion_bn.py
