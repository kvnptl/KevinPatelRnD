...
#SBATCH --output test_hrfuser_TINY_dense_r640_l_r_fusion_COCO_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_hrfuser_TINY_dense_r640_l_r_fusion_COCO_output.%j.err  # filename for STDERR
...
#############
python tools/test.py configs/hrfuser/cascade_rcnn_hrfuser_t_1x_stf_r1248_4mod_bn.py /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667/epoch_60.pth \
        --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/hrfuser_stf_4mod_stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667_COCO_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
        --eval bbox \
        --show \
        --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/hrfuser_stf_4mod_stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667_COCO_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
