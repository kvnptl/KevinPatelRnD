...
#SBATCH --output test_hrfuser_TINY_dense_cameara_only_COCO_day_night_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_hrfuser_TINY_dense_cameara_only_COCO_day_night_output.%j.err  # filename for STDERR
...
do
        python tools/test.py configs/hrformer/cascade_rcnn_hrformer_t_1x_stf_c1248_bn.py /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/camera_only/hrfuser_TINY_stf_c1248_camera_only_orig_setting_multi_gpu_4_2023-11-10_21-57-56_218957/epoch_60.pth \
                --weather dense_infos_${w} \
                --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_only/hrfuser_TINY_stf_c1248_camera_only_orig_setting_multi_gpu_4_2023-11-10_21-57-56_218957_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
                --eval bbox \
                --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_only/hrfuser_TINY_stf_c1248_camera_only_orig_setting_multi_gpu_4_2023-11-10_21-57-56_218957_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
