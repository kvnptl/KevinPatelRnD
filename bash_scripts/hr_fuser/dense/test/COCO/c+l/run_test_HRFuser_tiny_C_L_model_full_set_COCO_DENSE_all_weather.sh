...
#SBATCH --output test_hrfuser_TINY_dense_c_l_COCO_day_night_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_hrfuser_TINY_dense_c_l_COCO_day_night_output.%j.err  # filename for STDERR
...
do
        python tools/test.py configs/hrfuser/cascade_rcnn_hrfuser_t_1x_stf_r1248_c_l_2mod_bn.py /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/camera_lidar/hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_2023-11-17_08-34-53_221906/epoch_60.pth \
                --weather dense_infos_${w} \
                --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_lidar/hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_2023-11-17_08-34-53_221906_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
                --eval bbox \
                --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_lidar/hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_2023-11-17_08-34-53_221906_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
