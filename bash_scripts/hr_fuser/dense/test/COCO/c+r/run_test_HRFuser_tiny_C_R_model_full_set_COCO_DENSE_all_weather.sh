...
#SBATCH --output test_hrfuser_TINY_dense_c_r_SAF_FCOS_COCO_day_night_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_hrfuser_TINY_dense_c_r_SAF_FCOS_COCO_day_night_output.%j.err  # filename for STDERR
...
do
        python tools/test.py configs/hrfuser/cascade_rcnn_hrfuser_t_1x_stf_r1248_4mod_bn_saf_fcos.py /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/camera_radar/hrfuser_TINY_stf_C_R_2mod_orig_setting_A100_gpu_4_2023-11-17_04-24-04_221900/epoch_60.pth \
                ...
                --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_radar/hrfuser_TINY_stf_C_R_2mod_orig_setting_A100_gpu_4_2023-11-17_04-24-04_221900_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
                --eval bbox \
                --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/inference/coco/camera_radar/hrfuser_TINY_stf_C_R_2mod_orig_setting_A100_gpu_4_2023-11-17_04-24-04_221900_COCO_day_night_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
