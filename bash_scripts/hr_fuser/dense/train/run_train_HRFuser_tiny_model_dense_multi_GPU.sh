...
#SBATCH --output stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667.%j.err  # filename for STDERR
...
tools/dist_train.sh configs/hrfuser/cascade_rcnn_hrfuser_t_1x_stf_r1248_4mod.py \
                    4 \
                    --seed 0 \
                    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/stf_4mod_epo_60_batch_8_gpu_4_worker_8_lr_0p0006667
