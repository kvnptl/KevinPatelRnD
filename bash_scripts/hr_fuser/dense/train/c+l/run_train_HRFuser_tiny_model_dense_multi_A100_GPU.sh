...
#SBATCH --output train_hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_output.%j.err  # filename for STDERR
...
tools/dist_train.sh configs/hrfuser/cascade_rcnn_hrfuser_t_1x_stf_r1248_c_l_2mod_orig.py \
                    4 \
                    --seed 0 \
                    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/hrfuser_weights/dense/work_dirs/camera_lidar/hrfuser_TINY_stf_C_L_2mod_orig_setting_A100_gpu_4_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} 
