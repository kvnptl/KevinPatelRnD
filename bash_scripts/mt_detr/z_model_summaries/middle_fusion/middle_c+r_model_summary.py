...
├─MiddleFusion_two (backbone)                                          [1, 6, 711, 1333]    [1, 256, 88, 166]    41,344               True
...
│    │    └─ModuleList (downsample_layers)                             --                   --                   (recursive)          True
│    │    └─ModuleList (stages)                                        --                   --                   (recursive)          True
│    └─SimpleFusionModule (fusion)                                     --                   --                   (recursive)          True
│    │    └─ModuleList (fusion_layers)                                 --                   --                   (recursive)          True
│    │    └─LayerNorm (norm1)                                          [1, 256, 88, 166]    [1, 256, 88, 166]    512                  True
│    └─ConvNeXt (model1)                                               --                   --                   (recursive)          True
│    │    └─ModuleList (downsample_layers)                             --                   --                   (recursive)          True
│    │    └─ModuleList (stages)                                        --                   --                   (recursive)          True
│    └─ConvNeXt (model2)                                               --                   --                   (recursive)          True
...
│    └─SimpleFusionModule (fusion)                                     --                   --                   (recursive)          True
│    │    └─ModuleList (fusion_layers)                                 --                   --                   (recursive)          True
│    │    └─LayerNorm (norm2)                                          [1, 512, 44, 83]     [1, 512, 44, 83]     1,024                True
│    └─ConvNeXt (model1)                                               --                   --                   (recursive)          True
│    │    └─ModuleList (downsample_layers)                             --                   --                   (recursive)          True
│    │    └─ModuleList (stages)                                        --                   --                   (recursive)          True
│    └─ConvNeXt (model2)                                               --                   --                   (recursive)          True
...
│    └─SimpleFusionModule (fusion)                                     --                   --                   (recursive)          True
│    │    └─ModuleList (fusion_layers)                                 --                   --                   (recursive)          True
│    │    └─LayerNorm (norm3)                                          [1, 1024, 22, 41]    [1, 1024, 22, 41]    2,048                True
├─ChannelMapper (neck)                                                 [1, 256, 88, 166]    [1, 256, 88, 166]    --                   True
│    └─ModuleList (convs)                                              --                   --                   --                   True
│    │    └─ConvModule (0)                                             [1, 256, 88, 166]    [1, 256, 88, 166]    66,048               True
│    │    └─ConvModule (1)                                             [1, 512, 44, 83]     [1, 256, 44, 83]     131,584              True
│    │    └─ConvModule (2)                                             [1, 1024, 22, 41]    [1, 256, 22, 41]     262,656              True
│    └─ModuleList (extra_convs)                                        --                   --                   --                   True
│    │    └─ConvModule (0)                                             [1, 1024, 22, 41]    [1, 256, 11, 21]     2,359,808            True
├─DeformableDETRHead (bbox_head)                                       [1, 256, 88, 166]    [6, 1, 300, 2]       --                   True
│    └─SinePositionalEncoding (positional_encoding)                    [1, 88, 166]         [1, 256, 88, 166]    --                   --
│    └─SinePositionalEncoding (positional_encoding)                    [1, 44, 83]          [1, 256, 44, 83]     --                   --
│    └─SinePositionalEncoding (positional_encoding)                    [1, 22, 41]          [1, 256, 22, 41]     --                   --
│    └─SinePositionalEncoding (positional_encoding)                    [1, 11, 21]          [1, 256, 11, 21]     --                   --
│    └─DeformableDetrTransformer (transformer)                         [1, 256, 88, 166]    [6, 300, 1, 256]     6,387,968            True
│    │    └─DetrTransformerEncoder (encoder)                           --                   [19393, 1, 256]      4,541,184            True
│    │    └─Linear (enc_output)                                        [1, 19393, 256]      [1, 19393, 256]      65,792               True
│    │    └─LayerNorm (enc_output_norm)                                [1, 19393, 256]      [1, 19393, 256]      512                  True
│    └─ModuleList (cls_branches)                                       --                   --                   (recursive)          True
│    │    └─Linear (6)                                                 [1, 19393, 256]      [1, 19393, 2]        514                  True
│    └─ModuleList (reg_branches)                                       --                   --                   (recursive)          True
│    │    └─Sequential (6)                                             [1, 19393, 256]      [1, 19393, 4]        132,612              True
...
│    └─GIoULoss (loss_iou)                                             [300, 4]             --                   --                   --
│    └─L1Loss (loss_bbox)                                              [300, 4]             --                   --                   --
│    └─FocalLoss (loss_cls)                                            [19393, 2]           [1]                  --                   --
│    └─GIoULoss (loss_iou)                                             [19393, 4]           --                   --                   --
│    └─L1Loss (loss_bbox)                                              [19393, 4]           --                   --                   --
======================================================================================================================================================
Total params: 204,172,330
Trainable params: 204,172,330
Non-trainable params: 0
Total mult-adds (G): 91.24
======================================================================================================================================================
Input size (MB): 22.75
Forward/backward pass size (MB): 13557.37
Params size (MB): 764.10
Estimated Total Size (MB): 14344.22
======================================================================================================================================================