...
#SBATCH --output test_mt_detr_c+r_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_mt_detr_c+r_output.%j.err  # filename for STDERR
...
echo "[bash] Start testing MT-DETR Camera + Radar model on DENSE dataset..."
...
do
    python tools/test.py \
        ...
        /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/camera_radar_multi_single_A100_gpu_2023-11-04_09-47-18_214472/epoch_36.pth \
        --weather ${w} \
        --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/inference/camera_radar_multi_single_A100_gpu_2023-11-04_09-47-18_214472_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
        --eval bbox \
        --show \
        --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/inference/camera_radar_multi_single_A100_gpu_2023-11-04_09-47-18_214472_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
