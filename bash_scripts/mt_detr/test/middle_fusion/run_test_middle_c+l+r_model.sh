...
#SBATCH --output test_middle_c+l+r_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error test_middle_c+l+r_output.%j.err  # filename for STDERR
...
echo "[bash] Start testing middle Camera + Lidar + Radar model on DENSE dataset..."
...
do
    python tools/test.py \
        configs/mt_detr/middle_c+l+r.py \
        /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/middle_fusion/middle_camera_lidar_radar_single_A100_gpu_2023-11-02_23-14-53_214468/epoch_36.pth \
        --weather ${w} \
        --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/inference/middle_camera_lidar_radar_single_A100_gpu_2023-11-02_23-14-53_214468_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
        --eval bbox \
        --show \
        --show-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/inference/middle_camera_lidar_radar_single_A100_gpu_2023-11-02_23-14-53_214468_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
