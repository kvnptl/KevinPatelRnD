...
#SBATCH --error train_early_c+l+r_single_A100_gpu_50_perc_output.%j.err  # filename for STDERR
...
python tools/train.py \
    configs/mt_detr/early_c+l+r_50_perc.py \
    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/early_fusion/early_camera_lidar_radar_single_A100_gpu_50_perc_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
    --gpu-ids 1
