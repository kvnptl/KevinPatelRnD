...
#SBATCH --output train_early_c+l+r_single_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_early_c+l+r_single_gpu_output.%j.err  # filename for STDERR
...
python tools/train.py \
    ...
    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/early_fusion/early_camera_lidar_radar_single_gpu_${CURRENT_DATE_TIME}_${SLURM_JOB_ID}
