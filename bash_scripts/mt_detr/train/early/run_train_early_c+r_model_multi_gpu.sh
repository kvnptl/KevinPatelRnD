...
#SBATCH --output train_early_c+r_multi_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_early_c+r_multi_gpu_output.%j.err  # filename for STDERR
...
tools/dist_train.sh configs/mt_detr/early_c+r.py \
                    4 \
                    --seed 0 \
                    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/early_fusion/early_camera_radar_multi_gpu_${CURRENT_DATE_TIME}_${SLURM_JOB_ID}
