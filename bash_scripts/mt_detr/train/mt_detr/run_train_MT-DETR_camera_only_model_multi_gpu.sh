...
#SBATCH --output train_mt_detr_camera_only_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_mt_detr_camera_only_output.%j.err  # filename for STDERR
...
tools/dist_train.sh configs/mt_detr/camera_only.py \
                    4 \
                    --seed 0 \
                    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/camera_only_multi_gpu_${CURRENT_DATE_TIME}_${SLURM_JOB_ID}
