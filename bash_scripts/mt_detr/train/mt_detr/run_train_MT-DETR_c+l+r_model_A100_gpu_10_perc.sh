...
python tools/train.py \
    ...
    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/c_l_r/camera_lidar_radar_single_multi_single_A100_gpu_10_perc_${CURRENT_DATE_TIME}_${SLURM_JOB_ID} \
    --gpu-ids 0
