...
#SBATCH --output train_mt_detr_c+l+r_single_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_mt_detr_c+l+r_single_gpu_output.%j.err  # filename for STDERR
