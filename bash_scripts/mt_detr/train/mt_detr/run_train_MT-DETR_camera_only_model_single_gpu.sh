...
python tools/train.py \
    ...
    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/camera_only_single_gpu_${CURRENT_DATE_TIME}_${SLURM_JOB_ID}
