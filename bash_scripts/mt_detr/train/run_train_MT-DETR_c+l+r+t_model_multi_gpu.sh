...
#SBATCH --output train_mt_detr_c+l+r+t_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_mt_detr_c+l+r+t_output.%j.err  # filename for STDERR
...
tools/dist_train.sh configs/mt_detr/mt_detr_c+l+r+t.py \
                    4 \
                    --seed 0 \
                    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/camera_lidar_radar_time_multi_gpu
