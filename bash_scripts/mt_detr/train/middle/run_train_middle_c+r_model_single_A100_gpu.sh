...
#SBATCH --output train_middle_c+r_single_A100_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_middle_c+r_single_A100_gpu_output.%j.err  # filename for STDERR
