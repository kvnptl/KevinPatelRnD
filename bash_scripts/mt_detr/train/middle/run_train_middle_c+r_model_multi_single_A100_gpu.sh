...
#SBATCH --output train_middle_c+r_multi_single_A100_gpu_output.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error train_middle_c+r_multi_single_A100_gpu_output.%j.err  # filename for STDERR
...
python tools/train.py \
    ...
    --work-dir /home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/mt_detr_weights/work_dirs/middle_fusion/middle_camera_radar_single_A100_gpu_${CURRENT_DATE_TIME}_${SLURM_JOB_ID}
